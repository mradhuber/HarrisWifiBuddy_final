...
public class MainActivity extends AppCompatActivity {
        ...
        private static Button main_to_settings, map, main_to_network;
        @Override
    ...
    public void onClickNetworkButtonListener() {

        main_to_network = (Button)findViewById(R.id.nname1);
        main_to_network.setOnClickListener(
                new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        Intent intent = new Intent("com.harris.harriswifibuddy.network_login");
                        startActivity(intent);
                    }
                }
        );
